...
public class TaskController {
    ...
    public void save(Task task) {
        ...
        try {
            ...
            stmt.setString(3, task.getDescription("Devem ser criadas telas para os cadastros"));
            stmt.setString(4, task.getNotes("Sem notas"));
    ...
    public void update(Task task) {
        ...
        try {
            ...
            stmt.setString  (5, task.getNotes("Sem notas"));
